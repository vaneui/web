...
| Prop | Description |
|------|-------------|
| `justifySelfAuto` | Use the parent's justify-items value (`justify-self: auto`) |
| `justifySelfStart` | Align this item to the start of the inline axis |
| `justifySelfEnd` | Align this item to the end of the inline axis |
| `justifySelfCenter` | Center this item on the inline axis |
| `justifySelfStretch` | Stretch this item to fill the inline axis |
