...
return (
  <>
    <Button onClick={() => setOpen(true)}>Show Gradient Overlay</Button>
    <Overlay
      open={open}
...
return (
  <Card relative className="h-64">
    ...
    <Button onClick={() => setOpen(true)}>Show scoped overlay</Button>
...
return (
  <>
    <Row>
      <Button onClick={() => setOpenSlow(true)}>Slow fade (500ms)</Button>
      <Button onClick={() => setOpenInstant(true)}>Instant</Button>
    </Row>

    {/* Slow fade - 500ms */}
    <Overlay open={openSlow} onClose={() => setOpenSlow(false)} transitionDuration={500}>
      <Card>Slow transition content</Card>
    </Overlay>

    {/* Instant - no animation */}
    <Overlay open={openInstant} onClose={() => setOpenInstant(false)} noAnimation>
